    ...
    <>
      <div className="app">
        ...
        <button 
          ...
          id="sidebar-toggle"
        >
          <span aria-hidden="true" style={{fontSize: "2em"
}
...
`
                    ...
                    >
                      <span className="sidebar-icon" aria-hidden="true">{link.icon
}
</span>
                      <span>{link.label
}
...
/* ---- All major placeholders/section text remain unchanged except heading and branding text update ---- */
        <label htmlFor="issue" style={{ fontWeight: "500" 
}

}
>Legal Issue<span style={{ color: 'var(--accent)' 
}
...
> *</span></label>
 ...
 />
        ...
        <label htmlFor="urgency" style={{ fontWeight: "500" 
}
...
>
        ...
        <label htmlFor="budget" style={{ fontWeight: "500" 
}

}
>Budget Preference</label>
...
>
      {highlights.map((f, i) => (
        ...
        >
          <span style={{ fontSize: "2.2rem", color: "var(--primary)" 
}
...
>{f.title
          ...
          <span style={{ fontSize: "0.98rem", lineHeight: 1.18, color: "#444", textAlign: "center" 
}
...
>
      <h1 className="title"><span role="img" aria-label="Docs" style={{ marginRight: 10 
}

}
>📄</span>Legal Document Generator</h1>
...
>
      <h1 className="title"><span role="img" aria-label="Cases" style={{ marginRight: 10 
}

}
>🗂️</span>Case Tracker</h1>
      <div className="description">
...
>
      <h1 className="title"><span role="img" aria-label="Rights" style={{ marginRight: 10 
}

}
>⚖️</span>Know Your Rights</h1>
      <div className="description">
...
>
      <h1 className="title"><span role="img" aria-label="Q&A" style={{ marginRight: 10 
}

}
>💬</span>Anonymous Q&A Forum</h1>
      <div className="description">
...
>
      <h1 className="title"><span role="img" aria-label="Sign In" style={{ marginRight: 10 
}
